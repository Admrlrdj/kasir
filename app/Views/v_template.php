    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?= base_url('Admin') ?>" class="brand-link">
                ...
                <span class="brand-text font-weight-light">RdjKasir</span>
            </a>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; <a href="<?= base_url('Admin') ?>">RdjKasir</a>.</strong> All rights reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
</body>
